 ...
 * 2019-07-18T11:13:20.584-07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "ImagingService",
                  wsdlLocation = "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/imaging_2.5.wsdl",
...
public class ImagingService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/imaging_2.5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ImagingService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/imaging_2.5.wsdl");
        }
        WSDL_LOCATION = url;
    }
