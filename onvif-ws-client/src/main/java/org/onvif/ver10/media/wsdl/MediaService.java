 ...
 * 2019-07-18T11:13:25.766-07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "MediaService",
                  wsdlLocation = "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/media_2.6.wsdl",
...
public class MediaService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/media_2.6.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MediaService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/media_2.6.wsdl");
        }
        WSDL_LOCATION = url;
    }
