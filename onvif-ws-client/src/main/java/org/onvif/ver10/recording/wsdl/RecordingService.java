 ...
 * 2019-07-18T11:13:38.098-07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "RecordingService",
                  wsdlLocation = "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/recording_2.5.wsdl",
...
public class RecordingService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/recording_2.5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RecordingService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/recording_2.5.wsdl");
        }
        WSDL_LOCATION = url;
    }
