 ...
 * 2019-07-18T11:13:46.369-07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "SearchService",
                  wsdlLocation = "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/search_2.4.2.wsdl",
...
public class SearchService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/search_2.4.2.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SearchService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/search_2.4.2.wsdl");
        }
        WSDL_LOCATION = url;
    }
