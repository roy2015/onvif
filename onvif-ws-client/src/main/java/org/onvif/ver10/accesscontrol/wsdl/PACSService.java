 ...
 * 2019-07-18T11:12:55.465-07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "PACSService",
                  wsdlLocation = "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/accesscontrol_1.0.wsdl",
...
public class PACSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/accesscontrol_1.0.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PACSService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/accesscontrol_1.0.wsdl");
        }
        WSDL_LOCATION = url;
    }
