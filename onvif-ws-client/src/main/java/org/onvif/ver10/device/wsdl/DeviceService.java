 ...
 * 2019-07-18T11:13:11.035-07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "DeviceService",
                  wsdlLocation = "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/devicemgmt_2.5.wsdl",
...
public class DeviceService extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/devicemgmt_2.5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DeviceService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/spring/onvif/onvif-ws-client/src/main/resources/wsdl/devicemgmt_2.5.wsdl");
        }
        WSDL_LOCATION = url;
    }
